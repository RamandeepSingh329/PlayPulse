// android-search-script.js

document.addEventListener('DOMContentLoaded', function() {
    const searchInput = document.getElementById('androidSearchInput'); // Assuming an input with id "androidSearchInput"
    const searchDropdown = document.getElementById('androidSearchDropdown'); // Assuming a div with id "androidSearchDropdown"
    ...
    function fetchArtistChannels(searchTerm) {
        const mockChannels = [
            // ... (your mockChannels data from the previous script) ...
            ...
            { name: 'Heater - Inderpal Moga Ft AR Paisley & Channi Nattan', channelUrl: 'https://www.youtube.com/watch?v=d5sTRkJk9Ls&pp=ygUUaGVhdGVyIGluZGVycGFsIG1vZ2E%3D', keywords: ['heater', 'inderpal moga', 'chani nattan'], img: 'https://i.ytimg.com/vi/d5sTRkJk9Ls/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAgblPgO-2Ep9sQoPZzybCNtdKB9g', },
            { name: 'Unforgetable - Chani Nattan Ft Diljit Dosanjh & Intense', channelUrl: 'https://www.youtube.com/watch?v=vBS8_RuRz54&pp=ygUadW5mb3JnZXRhYmxlIGluZGVycGFsIG1vZ2E%3D', keywords: ['unforgettable','diljit dosanjh', '', 'chani nattan'], img: 'https://i.ytimg.com/vi/vBS8_RuRz54/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLDgu-9vYridyfxZZFzwYMIs-HvBWw', },
            { name: 'Shohrat - Jordan Sandhu', channelUrl: 'https://www.youtube.com/watch?v=7rQqzAD_DOw&pp=ygUVc2hvaHJhdCBqb3JkYW4gc2FuZGh1', keywords: ['shohrat','jordan sandhu', '', ''], img: 'https://i.ytimg.com/vi/7rQqzAD_DOw/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCDJIZAUr9dYDc-b_lcXf5ckz1r-A', },
            { name: 'Shikaytan - Nimrat Khaira ', channelUrl: 'https://www.youtube.com/watch?v=Lu2P1E3KTxI&pp=ygUXc2hpa2F5dGFuIG5pbXJhdCBraGFpcmE%3D', keywords: ['shikaytan','nimrat khaira', '', ''], img: 'https://i.ytimg.com/vi/Lu2P1E3KTxI/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAstQJCDHEsRGSSbRy1YIkiwTyvXw', },
            { name: 'Tension - Diljit Dosanjh  ', channelUrl: 'https://www.youtube.com/watch?v=hNgI9E_-v24&pp=ygUWdGVuc2lvbiBkaWxqaXQgZG9zYW5qaA%3D%3D', keywords: ['tension','diljit dosanjh', '', ''], img: 'https://i.ytimg.com/vi/hNgI9E_-v24/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLC2p1QVqdDwc2LpScsIoR9B7aToBw', },
            { name: 'Don - Diljit Dosanjh  ', channelUrl: 'https://www.youtube.com/watch?v=a8HeAvHBmzk&pp=ygUSZG9uIGRpbGppdCBkb3Nhbmpo', keywords: ['don','diljit dosanjh', 'd', ''], img: 'https://i.ytimg.com/vi/a8HeAvHBmzk/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAVzqHHziEbE_-0Gvd1ELFwPjX0ng', },
            { name: 'Black & White - Diljit Dosanjh  ', channelUrl: 'https://www.youtube.com/watch?v=q-U5nCDAgtY&pp=ygUcYmxhY2sgJiB3aGl0ZSBkaWxqaXQgZG9zYW5qaA%3D%3D', keywords: ['black & white','diljit dosanjh', 'black and white', ''], img: 'https://i.ytimg.com/vi/q-U5nCDAgtY/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCwz1YI_D9fgubeDo80mXmXLUwDOw', },
        ];
        ...
        displaySearchResults(filteredChannels);
    }
    ...
    function displaySearchResults(results) {
        ...
        results.forEach(channel => {
            ...
            resultItem.innerHTML = `
                <img src="${channel.img}" style="width: 50px; height: 50px; vertical-align: middle; margin-right: 10px;">
                <span style="vertical-align: middle;">${channel.name}</span>
            `;

            resultItem.addEventListener('click', () => {
                // Handle channel selection (e.g., navigate to channelUrl)
                window.location.href = channel.channelUrl;
                searchDropdown.style.display = 'none';
    ...
    searchInput.addEventListener('input', function() {
        ...
        debounceTimer = setTimeout(() => {
            if (searchTerm) {
                fetchArtistChannels(searchTerm);
                isSearchActive = true;
            } else {
                searchDropdown.style.display = 'none';
    ...
    // Optionally handle clicks outside the dropdown to close it
    ...
    // Optionally handle focus on the input to show the dropdown if it was previously active
    searchInput.addEventListener('focus', function() {
        if (isSearchActive && searchDropdown.innerHTML) {
            searchDropdown.style.display = 'block';
        }
    });
});